...
const MainHeader = () => {
  const IMAGES = ["/public/img/b_web_slider_connie"];

  return (
    <div>
      <Nav />
      <div className="bg-[url(/img/b_web_slider_connie.jpeg)] h-screen bg-no-repeat bg-cover flex">
        <div className="px-4 py-16 mx-auto my-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
