        ...
        <Modal.Body>
          <form className="flex flex-col gap-4" onSubmit={onSave}>
            ...
            <Textarea
              rows={4}
              value={text}
              onChange={(event) => setPin({ ...pin, text: event.target.value })}
                    ...
                    <div className="w-full flex flex-col">
                      ...
                      <div className="flex flex-row mt-2">
                        ...
                        <button
                          ...
                          className="ml-auto w-9 focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-2.5 py-2.5 mt-2"
                        >
                          <svg
