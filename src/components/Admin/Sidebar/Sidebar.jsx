...
const Sidebar = () => {
  ...
  const { unsetToken } = useAuthContext();
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Pins</span>
              </Link>
            </li>
            <li>
              <Link
            ...
            <li>
              <button
                ...
                className="flex w-full items-center p-2 text-primary-100 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
